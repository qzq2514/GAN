...
#WGAN-GP 参数
lambd = 0.25    #lambd:梯度惩罚在总体损失中的权重

model_path="models/"
pb_path=os.path.join(model_path,"pb/")
ckpt_path=os.path.join(model_path,"ckpt/")
result_dir = "mnist_result"
...
def train():
    ...
    GANer=WGANGP_mnist.WGANGP_mnist(is_training_placeholder,class_num,batch_size,
    ...
    g_loss, d_loss = GANer.loss(real_logist, generated_logits,real_data_placeholder,generated_data)
