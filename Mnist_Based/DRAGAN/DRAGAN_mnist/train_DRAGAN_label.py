...
from net import DRAGAN_mnist_label
import cv2
import time
import numpy as np
...
def train():
    ...
    GANer=DRAGAN_mnist_label.DRAGAN_mnist(is_training_placeholder,class_num,batch_size,
    ...
    g_loss, d_loss = GANer.loss(real_prop, generated_prop,real_data_placeholder,label_placeholder)
