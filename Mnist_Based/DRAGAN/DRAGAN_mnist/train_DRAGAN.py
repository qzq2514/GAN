...
def train():
    ...
    GANer=DRAGAN_mnist.DRAGAN_mnist(is_training_placeholder,class_num,batch_size,
    ...
    with tf.control_dependencies(tf.get_collection(tf.GraphKeys.UPDATE_OPS)):
        g_train_opt = tf.train.AdamOptimizer(learning_rate*5,beta1=beta1).\
