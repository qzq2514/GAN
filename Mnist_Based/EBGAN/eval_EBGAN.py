...
import cv2
import time
#'models/pb/EBGAN_mnist-22200.pb'
#'fashion_models/pb/EBGAN_mnist_fashion-34800.pb'
model_path = 'models/pb/EBGAN_mnist-22200.pb'
...
def eval():
    ...
    while True:
        ...
        cv2.imwrite("result/{}.jpg".format(ind),image_show)
