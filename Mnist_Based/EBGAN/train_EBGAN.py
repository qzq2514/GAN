...
dataset ="MNIST_fashion" #"MNIST_data"
...
model_name="EBGAN_mnist_fashion"
...
def train():
    ...
    mnist_GANer=EBGAN_mnist.EBGAN_mnist(is_training_placeholder,num_class,batch_size,image_height,
                                        image_width,channels,PT_loss_weight,margin)
    ...
    g_loss, d_loss = mnist_GANer.loss(real_recon_error, fake_recon_error, fake_code)
