...
from net import WGAN_mnist_label
import cv2
import time
import numpy as np
...
data_set_path = "../Data/MNIST_fashion"
model_name="WGAN_fashion"
...
def train():
    ...
    GANer=WGAN_mnist_label.WGAN_mnist(is_training_placeholder,class_num,batch_size,
