...
#'models_fashion/pb/BEGAN_fashion-2400.pb'
#'models/pb/BEGAN_mnist-3800.pb'
model_path = 'models_fashion/pb/BEGAN_fashion-2400.pb'
...
def eval():
    ...
    while True:
        ...
        cv2.imwrite("fashion_result/{}.jpg".format(ind),image_show)
