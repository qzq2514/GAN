...
from net import BEGAN_cartoon as BEGAN_cartoon
import numpy as np
import DataLoader
import time
import cv2
...
model_name="BEGAN_cartoon_new"

def train():

    dataLoader = DataLoader.Cartoo_loader(image_dir, batch_size,image_height, image_width, channels)

    real_data_placeholder = tf.placeholder(tf.float32,shape=[batch_size,image_height,image_width,channels],name="real_data")
    ...
    mnist_GANer=BEGAN_cartoon.BEGAN_cartoon(is_training_placeholder,num_class,batch_size,image_height,
    ...
    with tf.Session() as sess:
        ...
        for _ in range(epochs):
            ...
            for _ in range(step_per_epoch):
                ...
                batch_images = batch_images.reshape((batch_size,image_height,image_width,channels))
