...
def train():
    ...
    mnist_GANer=ACGAN_mnist.ACGAN_mnist(smooth,is_training_placeholder,num_class,batch_size)
    ...
    d_sigmoid_real, q_cat_logit_real = \
         mnist_GANer.discriminator(real_data_placeholder)
    d_sigmoid_fake, q_cat_logit_fake = \
        mnist_GANer.discriminator(generated_data,reuse=True)
