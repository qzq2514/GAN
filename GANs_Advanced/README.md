...
# Pix2Pix  
Unlike DiscoGAN、DualGAN and CycleGAN,Pix2Pix need paired data to train and it can only generate picture from one domain to another,so I train Edge2Shoes and Shoes2Edge Separately.
|   Edge2Shoes   | Shoes2Edge|  
|:------------:|:-------------------:|  
